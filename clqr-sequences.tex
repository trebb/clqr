...
\begin{LIST}{1cm}
  ...
  \IT{(\xorGOO{\FU*{EVERY}\\\FU*{NOTEVERY}}{\}} \VAR{test}
    \RP{\VAR{sequence}})} 
  ...
  as \VAR{test} on any element of \VAR{sequence} returns non-\NIL. 
...
\begin{LIST}{1cm}
  ...
  \VAR{sequence-a}. Return \retval{index} in \VAR{sequence-b}, or
  \retval{\NIL}. 
