...
\begin{LIST}{1cm}
  ...
  \VAR{ord-$\lambda$}s to values of \VAR{test} and return \retval{values of
    \VAR{form}s} or, without a \kwd{:no-error} clause, return
  \retval{values of \VAR{test}}. See p.\ \pageref{section:Functions}
...
\end{figure}
  ...
  {
  \retval{Function} or \retval{list of its operands}, respectively, used in signalling operation.
  }
  ...
  {
  \retval{Datum} which caused \VAR{condition}, or its expected type,
  respectively. 
  }
