...
\begin{LIST}{1cm}
      ...
      \PROGN{\VAR{restart-form}})})}
  {
    ...
    (\OPn{\VAR{ord-$\lambda$}}); see p.\ \pageref{section:Functions}
    for the latter.
  }
  ...
  {
    Return \retval{values of \VAR{form}s} evaluated with
    \VAR{restart}s dynamically bound to \VAR{restart-function}s. 
  }
