...
\begin{LIST}{1cm}
  ...
  {
  Signal \kwd{simple-error} as denoted by \VAR{datum} and \VAR{arg}s unless
  error is handled. 
  }
  ...
  {
  Return \retval{values of \VAR{form}s} as in \kwd{progn} or, in case of \kwd{error}s,
  ...
  \VAR{fu-arg}s to values of \VAR{test} and return \retval{values of
