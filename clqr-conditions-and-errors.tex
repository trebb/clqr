...
\begin{LIST}{1cm}
  ...
  with \FU{format} \VAR{control} and \VAR{arg}s (see page \pageref{section:Format}),
          ...
          \VAR{control}\text{ } \OPn{\VAR{arg}}}{\}}}})}
  {
    ...
    page \pageref{section:Format}), \kwd{error}. When using the
    ...
    \OPn{\VAR{arg}}) \PROGN{\VAR{form}})}
  {
    ...
    page \pageref{section:Format}) and return \retval{\NIL}
    and \retvalii{\T}.
  }
