...
\begin{LIST}{1cm}
  ...
  \retval{\NIL} or explicitly \retval{\MC{return}ed value}.
...
\begin{figure}%
  \begin{center}%
    \begin{sideways}%
      ...
      \left\{
      \begin{array}{l}
        \text{\LKWD{with} \VAR{var-s} \Op{\VAR{type}} \LKWD{=} \VAR{foo }} 
        \{\text{\LKWD{and} \VAR{var-p} \Op{\VAR{type}} \LKWD{=}
          \VAR{bar}\}}^{*} \\[.1ex]
        \left.\!
        \begin{array}{l}
          \text{\LKWD{for}}  \\
...
\begin{LIST}{1cm}
  ...
  \begin{LIST}{.5cm}
    ...
    \IT{\Goop{\LKWD*{with} \VAR{var-s} \Op{\VAR{type}} \LKWD*{=} \VAR{foo}} \Goos{\LKWD*{and}
        \VAR{var-p} \Op{\VAR{type}} \LKWD*{=} \VAR{bar}}}
    {
    Initialize local variables \VAR{var-s} sequentially and \VAR{var-p} in parallel.
    }
    ...
    \IT{\GOo{\Goo{\LKWD*{for}\XOR\LKWD*{as}} \XOR\ \LKWD*{and}} \VAR{var} \Op{\VAR{type}}}
    {
