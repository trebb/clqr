...
\begin{flushleft}
  ...
  \xorGOO{%
    ...
    (\OPn{\VAR{macro-$\lambda$}})}{\}}).
  \penalty-5
  One toplevel \Op{\VAR{\&Ev}} may be replaced by \kwd*{\&environment}
...
\begin{LIST}{1cm}
  ...
  }
  {
    ...
    and \OPn{\VAR{var}} describe the arguments of \VAR{function} and
    the value(s) to be stored, respectively. \VAR{form}s must provide for returning
    the value(s) of \OPn{\VAR{var}}.
  }
...
\begin{LIST}{1cm}
  ...
  error/non-correctable \kwd{type-error}, respectively, if no
  \VAR{keys} match and return \retval{\NIL} then. 
  }
        ...
        \boxed{
          ...
          \begin{array}{l}
            ...
            \right\} 
                ...
                \boxed{\mathbb{S}_j}\}^{*}\Op{\text{\LKWD{else}}%
