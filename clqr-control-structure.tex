...
\begin{flushleft}
  Below, macro lambda list (\OPn{\VAR{macro-arg}}) has the form of
  either
  \penalty-5
  ...
  \kwd{.} \VAR{var}).
  \penalty-5
  One \Op{\VAR{\&Ev}} may be replaced by \kwd*{\&environment} \VAR{var}.
  \VAR{supplied-p} is \T\ if there is a corresponding argument.
\end{flushleft}
...
\begin{LIST}{1cm}
  ...
  \IT{(\xorGOO{\MC*{DEFMACRO}\\\FU*{DEFINE-COMPILER-MACRO}}{\}}
    ...
    \OPn{\VAR{form}})}
  {
  Define macro \retval{\VAR{foo}}. %FIXME:AUGMENT
  }
  ...
  \IT{(\MC*{DEFSETF} \NEV{\VAR{function}} \xorGOO{%
      ...
      (\OPn{\VAR{setf-arg}}) \text{ } (\OPn{\VAR{var}}) \text{ } 
        \OPn{(\kwd{declare } \OPn{\NEV{\VAR{decl}}})}\text{ }
        \Op{\NEV{\VAR{doc}}} \text{ } \OPn{form}}{\}})
    \penalty-5
  where setf lambda list (\OPn{\VAR{setf-arg}}) has the form
  \penalty-5
  (\OPn{\VAR{var}}
  \OP{\kwd*{\&optional} \xorGOO{%
      \VAR{var}\\
