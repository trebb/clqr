...
\begin{LIST}{1cm}
  ...
  {
  Evaluate \kwd{TAGBODY}-like body with \VAR{var}s locally bound (in parallel or sequentially, respectively) to
  \VAR{value}s. Return \retval{\NIL} or explicitly
  \retval{\kwd{return}ed value}. 
  }
...
\begin{LIST}{1cm}
  ...
  \begin{LIST}{.5cm}
    ...
    \begin{LIST}{.5cm}
      ...
      \IT{\LKWD*{by} \Goo{\VAR{step}\DF{1}\XOR\VAR{function}\DF{\kwd{cdr}}}}
      {
