...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\MC}[1]{%
  \settowidth{\TAGwidth}{\tiny\sffamily\mdseries\hspace*{.5em}M}%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\SO}[1]{%
  \settowidth{\TAGwidth}{\tiny\sffamily\mdseries\hspace*{.5em}SO}%
  \settowidth{\KEYWORDwidth}{\lowercase{#1}}%
  \ifdim\TAGwidth > \KEYWORDwidth%
  \text{{\sffamily\bfseries\selectfont%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\FU}[1]{%
  \settowidth{\TAGwidth}{\tiny\sffamily\mdseries\hspace*{.5em}Fu}%
  \settowidth{\KEYWORDwidth}{\lowercase{#1}}%
  \ifdim\TAGwidth > \KEYWORDwidth%
  \text{{\sffamily\bfseries\selectfont%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\GFU}[1]{%
  \settowidth{\TAGwidth}{\tiny\sffamily\mdseries\hspace*{.5em}gF}%
  \settowidth{\KEYWORDwidth}{\lowercase{#1}}%
  \ifdim\TAGwidth > \KEYWORDwidth%
  \text{{\sffamily\bfseries\selectfont%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\V}[1]{%
  \settowidth{\TAGwidth}{\tiny\sffamily\mdseries\hspace*{.8em}var}%
  \settowidth{\KEYWORDwidth}{\lowercase{#1}}%
  \ifdim\TAGwidth > \KEYWORDwidth%
  \text{{\sffamily\bfseries\selectfont%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\CNS}[1]{%
  \settowidth{\TAGwidth}{\tiny\sffamily\mdseries\hspace*{.5em}co}%
  \settowidth{\KEYWORDwidth}{\lowercase{#1}}%
  \ifdim\TAGwidth > \KEYWORDwidth%
  \text{{\sffamily\bfseries\selectfont%
...
\newcommand{\retvaln}[2]{{%
      {\raisebox{-1.7ex}[1ex][0pt]{\tiny\sffamily\upshape\mdseries\makebox[0pt][l]{\hspace{-.1em}#1}}\uline{#2}}}}
