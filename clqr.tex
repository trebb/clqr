...
%
%
\def\startexplanation{$\triangleright$\hskip.8ex}
\newlength{\ITwidth}
\newlength{\ITrest}
...
\begin{flushleft}
  ...
  \begin{LIST}{1cm}
    ...
    \IT{\VAR{them}\DF{\LIT{foo}}}
    {
    Placeholder for actual code. Defaults to \LIT{foo}.
    }
