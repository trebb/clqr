  ...
  \begin{center}
    \boxGOO{%
      ...
      \boxGOO{%
        ...
        \boxGOO{%
          ...
          \boxGOO{%
            ...
            \boxGOO{%
              ...
              \kwd*{LONG-FLOAT } \OP{\VAR{lower-limit\footnotemark[3]
                }\Op{\VAR{upper-limit\footnotemark[3]}}}}}\boxGOOcr
          \kwd*{COMPLEX } \Op{\VAR{type\footnotemark[3]}}}\boxGOOcr
        \kwd*{SEQUENCE}
        \boxGOO{%
          \kwd*{LIST}
          \boxGOO{%
          ...
          \boxGOO{%
            ...
            \boxGOO{%
              ...
              \boxGOO{%
                ...
                \boxGOO{%
                  \kwd*{SIMPLE-BIT-VECTOR } \Op{\VAR{size\footnotemark[3]}}}\boxGOOcr
                ...
                \boxGOO{%
                  ...
                  \boxGOO{%
                    ...
                    \boxGOO{%
                      \kwd*{SIMPLE-BASE-STRING } \Op{\VAR{size\footnotemark[3]}}}}}\boxGOOcr
                \kwd*{SIMPLE-VECTOR } \Op{\VAR{size\footnotemark[3]}}}}\boxGOOcr
            \kwd*{VECTOR}  \OP{\VAR{type\footnotemark[3] }\Op{\VAR{size\footnotemark[3]}}}\\
            \boxGOO{%
              \kwd*{STRING} \Op{\VAR{size\footnotemark[3]}}
              \boxGOO{%
                \kwd*{BASE-STRING} \Op{\VAR{size\footnotemark[3]}}}\boxGOOcr
              \kwd*{BIT-VECTOR} \Op{\VAR{size\footnotemark[3]}}}}}\boxGOOcr
        \kwd*{CHARACTER}
        \boxGOO{%
          \kwd*{BASE-CHAR}
          \boxGOO{%
        ...
        \kwd*{ARRAY} \OP{\VAR{type\footnotemark[3] }\Op{\VAR{dimension\footnotemark[3]}}}\\
        \boxGOO{%
          \kwd*{SIMPLE-ARRAY} \OP{\VAR{type\footnotemark[3] }\Op{\VAR{dimension\footnotemark[3]}}}}\boxGOOcr
        \kwd*{ATOM},\>
        \kwd*{HASH-TABLE},\>
...
\begin{LIST}{1cm}
  ...
  \IT{(\MC*{TYPECASE} \VAR{foo} \OPn{(\NEV{\VAR{type}} \OPn{\VAR{form-a}})} 
    \OP{(\xorGOO{\kwd*{OTHERWISE}\\
        \T}{\}} \OPn{\VAR{form-b}\DF{\NIL}})})}
  {
  Return \retval{values of the \VAR{form-a}s} whose \VAR{type} is
  \VAR{foo} of. Return \retval{values of \VAR{form-b}s} if no
  \VAR{type} matches.
  }
  ...
  {
  Type specifier comprising \VAR{foo} or \VAR{foo}s.
  }
