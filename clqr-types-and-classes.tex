...
\begin{figure}
    ...
    \boxGOO{%
      ...
      \boxGOO{%
        ...
        \boxGOO{%
          ...
          \boxGOO{
            \kwd*{NULL}}}\boxGOOcr
          \kwd*{ARRAY}\footnotemark[2] \OP{\VAR{type}\DF{\kwd{\A}}\text{ }\Op{\VAR{dimension}\DF{\kwd{\A}}}}\\
          \boxGOO{%
            \kwd*{SIMPLE-ARRAY}\footnotemark[2] \OP{\VAR{type}\DF{\kwd{\A}}\text{ }\Op{\VAR{dimension}\DF{\kwd{\A}}}}\\
            \boxGOO{%
        ...
        \kwd*{ARRAY} \OP{\VAR{type}\DF{\kwd{\A}}\text{ }\Op{\VAR{dimension}\DF{\kwd{\A}}}}\\
        \boxGOO{%
          \kwd*{SIMPLE-ARRAY} \OP{\VAR{type}\DF{\kwd{\A}}\text{ }\Op{\VAR{dimension}\DF{\kwd{\A}}}}}\boxGOOcr
        \kwd*{CHARACTER}
        \boxGOO{%
          \kwd*{BASE-CHAR}
          \boxGOO{%
  ...
  \end{center}\vspace{-1em}
              ...
              {\footnotesize As a type argument, \kwd*{\A} means no restriction.}
...
\begin{LIST}{1cm}
  ...
  \IT{(\MC*{DEFTYPE} \VAR{foo} (\OPn{\VAR{macro-$\lambda$}}) %FIXME:BLOCK
  ...
  p.~\pageref{section:Macros} but with the default value of \VAR{init}
