...
\begin{LIST}{1cm}
  ...
  \IT{(\xorGOO{\FU*{INTERN}\\
      \FU*{FIND-SYMBOL}}{\}} \VAR{symbol} \Op{\VAR{package}})}
  {
  Intern or find, respectively, \retval{\VAR{symbol}} in
...
\begin{LIST}{1cm}
  ...
  \V*{\A gensym-counter\A} which is incremented only in case no \VAR{x}
  is given. 
  }
