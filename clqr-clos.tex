...
\begin{LIST}{1cm}
  ...
  \IT{\Goo{(\kwd*{AND})\XOR\kwd*{T}}}

  \IT{\Goo{(\kwd*{OR})\XOR\kwd*{NIL}}}
  ...
  \IT{(\kwd*{STANDARD})}
  Also used if no method combination type is given.
  ...
  \IT{(\SF*{DEFINE-METHOD-COMBINATION} \VAR{c-type} (\OPn{\VAR{fu-arg}})
