...
\begin{LIST}{1cm}
      ...
      (\kwd{:metaclass} \VAR{ name}\DF{\kwd{standard-class}})}{\}})}
  {
    ...
    via \Op{\kwd{:}}\VAR{initarg-name}; it is readable via (\VAR{reader}
  ...
  \IT{(\GFU*{MAKE-INSTANCE} \VAR{class} \Goos{\Op{\kwd{:}}\VAR{initarg}
      \VAR{value}} \OPn{\VAR{other-keyarg}})}
  {
    Make new \retval{instance of \VAR{class}}.
  }

  \IT{(\GFU*{REINITIALIZE-INSTANCE} \VAR{instance} \Goos{\Op{\kwd{:}}\VAR{initarg}
      \VAR{value}} \OPn{\VAR{other-keyarg}})}
  {
  ...
  \IT{(\GFU*{CHANGE-CLASS} \DES{\VAR{instance}} \VAR{new-class}
    \Goos{\Op{\kwd{:}}\VAR{initarg} \VAR{value}} \OPn{\VAR{other-keyarg}})}
  {
  ...
  \IT{(\GFU*{ALLOCATE-INSTANCE} \VAR{class} \Goos{\Op{\kwd{:}}\VAR{initarg}
      \VAR{value}} \OPn{\VAR{other-keyarg}})}
  {
