...
\begin{LIST}{1cm}
  ...
  \IT{(\kwd*{AREF} \VAR{array} \OP{\VAR{subscripts}})} Return
  ...
  result in \VAR{bit-arry}. If \VAR{arg} is \NIL, make a new array for
  result. 
  ...
  \VAR{bit-arry-a}. If \VAR{arg} is \NIL, make a new array for
  result. 
