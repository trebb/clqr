...
\begin{LIST}{1cm}
  ...
  \IT{\arrGOO{\V*{\A compile-file-pathname\A}\DF{\NIL}\\
      \V*{\A compile-file-truename\A}\DF{\NIL}}{.}}
  {
  Input file used by \FU{compile-file}.
  }

  \IT{\arrGOO{\V*{\A compile-print\A}\\
      \V*{\A compile-verbose\A}}{.}}
  {
  ...
  \IT{\arrGOO{\V*{\A load-pathname\A}\DF{\NIL}\\
      \V*{\A load-truename\A}\DF{\NIL}}{.}}
  {
  Input file used by \FU{load}.
  }

  \IT{\arrGOO{\V*{\A load-print\A}\DF{\NIL}\\
      \V*{\A load-verbose\A}}{.}}
  {
...
\begin{LIST}{1cm}
  ...
  \V{\A trace-output\A}. Return \retval{values of \VAR{form}s}. 
  }
...
\begin{LIST}{1cm}
  ...
  \IT{\arrGOO{(\FU*{PROCLAIM} \VAR{ decl})\\
      (\MC*{DECLAIM } \OPn{\NEV{\VAR{decl}}})}{.}} % FIXME:DECLARATION-ID-LIST
  {
