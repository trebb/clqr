...
\begin{LIST}{1cm}
  ...
  \IT{(\xorGOO{\FU*{BUTLAST }  \VAR{list}\\
    ...
    \Op{\VAR{num}\DF{\LIT{1}}})}
  {
  Return \retval{\VAR{list}} excluding last \VAR{num}
    conses.
  }
  ...
  \IT{(\FU*{PUSH} \VAR{foo} \DES{\VAR{place}})}
  {Set \VAR{place} to
  \retval{(\FU{cons} \VAR{foo} \VAR{place})}.
  }

  \IT{(\FU*{PUSHNEW} \VAR{foo} \DES{\VAR{place}}  \orGOO{\kwd{:test}
      \VAR{ function}\\
      \kwd{:test-not} \VAR{ function}\\
      \kwd{:key} \VAR{ function}}{\}})}
  {Set \VAR{place} to
  ...
  \IT{\arrGOO{(\FU*{APPEND } \Op{\OPn{\VAR{list}} \VAR{ foo}})\\
      (\FU*{NCONC } \Op{\OPn{\DES{\VAR{list}}} \VAR{ foo}})}{.}}
  {
  Return \retval{concatenated list}. \VAR{foo} can be of any type.
  }
