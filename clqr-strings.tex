...
see pages \pageref{section:Sequences} and \pageref{section:Arrays}.
...
\begin{LIST}{1cm}
  ...
  \IT{(\FU*{STRING} \VAR{x})}
  Convert \VAR{x} (symbol, string, or character) into a \retval{string}.
  ...
  Return \retval{string} with all characters in \VAR{char-bag} removed
  from both ends, from the beginning, or from the end, resp., of \VAR{string}.
