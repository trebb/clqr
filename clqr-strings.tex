...
\begin{LIST}{1cm}
  ...
  {\index{STRING-CAPITALIZE}%
    ...
    Return \retval{\VAR{string}} (not modified or modified,
    respectively) with first letter of every word turned into uppercase,
    letters all uppercase, or letters all lowercase, respectively.
  }
