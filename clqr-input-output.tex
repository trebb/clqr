...
\begin{LIST}{1cm}
  ...
  \kwd{format}, for \VAR{control} and \VAR{arg}s. 
  }
  ...
  \IT{(\FU*{READ-CHAR} \OP{\VAR{stream}\DF{\kwd{*standard-input*}}
  ...
  \IT{(\FU*{UNREAD-CHAR} \VAR{character}
    \Op{\VAR{stream}\DF{\kwd{*standard-input*}}})}
  {
  Put last \kwd{read-char}ed \VAR{character} back into \VAR{stream}; return
  \retval{\NIL}. 
  }
  ...
  \IT{(\FU*{COPY-READTABLE} \OP{\VAR{from-readtable}\DF{\kwd{*readtable*}}
    \Op{\VAR{to}\DF{\NIL}}})}
  {
