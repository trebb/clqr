...
\begin{LIST}{1cm}
  ...
  \IT{(\xorGOO{\FU*{READ}\\
    ...
    \OP{\DES{\VAR{stream}}\DF{\V{\A standard-input\A}} \OP{\VAR{eof-err}\DF{\T}
...
\begin{LIST}{1cm}
  ...
  \kwd{\A print-}\VAR{bar}\kwd{\A}). (\kwd{:stream} keyword with \FU{write} only.)
  }
  ...
  \begin{LIST}{.5cm}
    ...
    list in \VAR{list}, or \V{\A print-length\A} or \V{\A print-circle\A} indicate
...
\begin{LIST}{1cm}
  ...
  \begin{LIST}{.5cm}
    ...
    \IT{\KWD{\TLD}\Op{\VAR{n}\DF{\LIT{0}}}\Op{\KWD{:}}\Op{\KWD{@}}\KWD{\A}}
    {\index{~ *@$\sim$\A}
