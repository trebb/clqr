...
\begin{LIST}{1cm}
  ...
  \IT{\KWD*{(}\qquad\qquad\qquad\qquad}
  {
  ...
  \IT{\KWD{\#}\VAR{label}\kwd{\#}\qquad\qquad}
  {
  \index{\#\#}%
  Object labelled \VAR{label}.
  }

  \IT{\KWD*{\#P}\VAR{foo}\qquad\qquad}
  {
  A pathname.
  }
  ...
  \IT{\arrGOO{\KWD*{\#+}\VAR{features } \VAR{when-features}\\
      \KWD*{\#--}\VAR{features } \VAR{unless-features}}{.}} %FIXME:FEATURE-EXPRESSIONS
  {
  Means \VAR{when-features} if \VAR{features} is \T, means
  \VAR{unless-features} if \VAR{features} is \NIL.
  }
