...
\begin{LIST}{1cm}
  ...
  \IT{\KWD{\TLD}\Op{\KWD{:}}\Op{\KWD{@}}\KWD{\boldmath{$<$}}
    \OP{\Goo{\VAR{prefix}\DF{\LIT{""}}\KWD{\TLD;}}\XOR\Goo{\VAR{per-line-prefix}\KWD{\TLD@;}}}
    \VAR{body}\OP{\KWD{\TLD;}\VAR{suffix}\DF{\LIT{""}}}\KWD{\TLD:}\Op{\KWD{@}}\KWD{\boldmath{$>$}}}
  {\index{\~<\~:>@$\sim$$<$ $\sim$:$>$}
  ...
  {\index{\~*@$\sim$\A}
    ...
    \IT{\KWD{\TLD}\OP{\VAR{x} \OP{\kwd{,}\Op{\VAR{y}} \Op{\kwd{,}\VAR{z}}}}\KWD{\^{}}}
    {\index{\~\^{}@$\sim$\^{}}
