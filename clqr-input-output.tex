...
\begin{LIST}{1cm}
  ...
  \IT{\KWD*{\#b}\VAR{n}; \KWD*{\#o}\VAR{n}; \VAR{n}\kwd{.}; \KWD*{\#x}\VAR{n}; \KWD{\#}\VAR{r}\KWD{R}\VAR{n}}
  {
    \index{\#R}%
...
\begin{LIST}{1cm}
  ...
  {
  \retval{List of (\VAR{from-wildcard to-wildcard}) translations} for \VAR{logical-host}. \kwd{setf}able.
  }
  ...
  {
  \retval{Physical pathname} corresponding to (possibly logical) \VAR{pathname}. 
  }
